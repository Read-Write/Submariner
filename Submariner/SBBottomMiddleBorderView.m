...
#import "SBBottomMiddleBorderView.h"
...
@implementation SBBottomMiddleBorderView
...
- (void)drawRect:(NSRect)dirtyRect
{
    ...
    NSBezierPath *clipPath = [NSBezierPath bezierPathWithRect:drawingRect];
