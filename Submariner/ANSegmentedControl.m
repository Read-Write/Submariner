...
- (void)setSelectedSegment:(NSInteger)newSegment
{
    ...
    if (controlDelegate != nil && [controlDelegate respondsToSelector:@selector(segmentedControl:selectionDidChange:)]) {
        [controlDelegate segmentedControl:self selectionDidChange:[self selectedSegment]];
    }
}
