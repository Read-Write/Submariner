...
#import "SBBottomLeftBorderView.h"
...
@implementation SBBottomLeftBorderView
...
- (void)drawRect:(NSRect)dirtyRect
{
    ...
    NSBezierPath *clipPath = [NSBezierPath bezierPathWithRoundedRect:drawingRect cornerRadius:CORNER_CLIP_RADIUS inCorners:OSBottomLeftCorner];
