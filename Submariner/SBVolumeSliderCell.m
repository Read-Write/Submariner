...
#import "SBVolumeSliderCell.h"
#import "NSBezierPath+PXRoundedRectangleAdditions.h"

@implementation SBVolumeSliderCell
...
- (void)drawKnob:(NSRect)knobRect {
	...
	if([self isEnabled]) {
        ...
        //		NSBezierPath *offsetPath = [NSBezierPath bezierPathWithRoundedRect:NSOffsetRect(knobRect, 0, 0) cornerRadius:knobRect.size.width];
        //		[offsetPath stroke];
